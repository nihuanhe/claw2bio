...
**Option B — standalone zip** (~0.1 MB, served from this site): <https://claw2bio.site/downloads/qpcr-mtdna.zip>
...
- [Source & SKILL.md on GitHub](https://github.com/nihuanhe/claw2bio/tree/main/experiment-data/qpcr-mtdna)

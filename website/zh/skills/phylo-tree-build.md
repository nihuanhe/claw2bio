...
**方式 B —— 独立 zip 包**（约 17.9 MB，本站下载）：<https://claw2bio.site/downloads/phylo-tree-build.zip>

**方式 C —— 全量示例数据**（约 29.5 MB，本站下载）：<https://claw2bio.site/downloads/phylo-tree-build-examples.zip>
:::

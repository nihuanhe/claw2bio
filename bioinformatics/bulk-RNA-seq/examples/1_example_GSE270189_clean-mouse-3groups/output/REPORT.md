...
| `MA_Mutant_Rap_vs_Control.pdf` | 02_de (deseq2) | MA plot of one contrast — sanity check that normalisation worked and logFC is expression-independent |
| `MA_Mutant_Rap_vs_Control.png` | 02_de (deseq2) | MA plot of one contrast — sanity check that normalisation worked and logFC is expression-independent |
| `MA_Mutant_vs_Control.pdf` | 02_de (deseq2) | MA plot of one contrast — sanity check that normalisation worked and logFC is expression-independent |
| `MA_Mutant_vs_Control.png` | 02_de (deseq2) | MA plot of one contrast — sanity check that normalisation worked and logFC is expression-independent |
| `MA_Mutant_vs_Mutant_Rap.pdf` | 02_de (deseq2) | MA plot of one contrast — sanity check that normalisation worked and logFC is expression-independent |
| `MA_Mutant_vs_Mutant_Rap.png` | 02_de (deseq2) | MA plot of one contrast — sanity check that normalisation worked and logFC is expression-independent |

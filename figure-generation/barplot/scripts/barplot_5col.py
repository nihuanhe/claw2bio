...
# ============================================================
FIGURE_NAME = 'miRNA '          # ← 图片标题（显示在图表上方）
...
p_text_combined = '\n'.join(p_lines)
ax.text(1.03, 0.65, p_text_combined, transform=ax.transAxes, fontsize=9,
...
output_path = DATA_FILE.replace('.csv', '_barplot5col.png')
